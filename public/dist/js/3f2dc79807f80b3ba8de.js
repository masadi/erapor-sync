    ...
    tesKoneksi: function tesKoneksi() {
      ...
      if (!this.url) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
          type: 'error',
          title: 'Gagal',
          text: 'URL eRapor SMK tidak boleh kosong!',
          reverseButtons: true,
      ...
      var validUrl = this.validateUrl(this.url);
      this.prosesUrl();

      if (validUrl) {
        return this.prosesUrl();
      } else {}
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
        type: 'error',
        title: 'Gagal',
        text: 'URL eRapor SMK tidak valid. Silahkan periksa kembali!',
        reverseButtons: true,
