        ...
        _c(
          ...
          [
            ...
            _c("input", {
              ...
              attrs: { type: "text" },
              domProps: { value: _vm.sekolah_id },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.sekolah_id = $event.target.value
                }
              }
            }),
            _vm._v(" "),
