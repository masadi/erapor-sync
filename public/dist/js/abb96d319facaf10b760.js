...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    prosesKoneksi: function prosesKoneksi() {
      var _this = this;
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("/api/dapodik/cek-koneksi", {
        ...
        if (getData.status == 'success') {
          ...
          _this.danger = true;
          _this.danger_text = 'Koneksi ke aplikasi eRapor SMK gagal. Pastikan aplikasi eRapor SMK sudah memakai versi 5.1.1';
        }
